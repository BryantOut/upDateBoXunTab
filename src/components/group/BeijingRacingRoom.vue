    ...
    <div class='myHeader'>
      <router-link to='/Game' slot='left'>
        <div class='left'>
          ...
          <span class='text'>北京赛车<span>(52人)</span></span>
        </div>
      </router-link>
...
<script>
import KeyBoard1 from '../../components/keyboard/PcEggKeyBoard'
import { getBjOpenAPrizeHistory } from '@/api/index.js'
export default {
  data () {
    return {
      data: [],
  ...
  mounted () {
    ...
    getBjOpenAPrizeHistory({currentPage: 1, size: 10}).then(res => {
